...
export const en = {
  ...
  'onboarding.timeZone.title': 'Your time zone',
  'onboarding.timeZone.detected': 'We detected {zone}.',
  'onboarding.timeZone.why':
    'Your day starts and ends at local midnight, so meals land on the right date.',
  'onboarding.timeZone.looksRight': 'Looks right',
  'onboarding.timeZone.change': 'Change',
  ...
  'validation.timeZoneInvalid': 'Choose a valid time zone',
